const C='python-ai-definitive-v8',CORE=['./','./index.html','./styles.css','./secure-storage.js','./backend-sync.js','./context-controls.js','./app.js','./enhancements.js','./browser-tools.js','./manifest.webmanifest','./icon.svg'];
